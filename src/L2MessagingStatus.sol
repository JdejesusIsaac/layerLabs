...
contract L2MessagingStatus is AccessControlEnumerableUpgradeable, IStatusWrite, ConfigEvents, PauserEvents, ProtocolEvents, OAppSender, OAppReceiver {
    ...
    constructor(address _lzEndpoint) OAppCore(_lzEndpoint) {}
     ...
     */
    function oAppVersion() public pure override(OAppSender, OAppReceiver) returns (uint64 senderVersion, uint64 receiverVersion)
    {
