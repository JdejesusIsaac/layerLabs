...
contract L1MessagingStatus is AccessControlEnumerableUpgradeable, OwnableUpgradeable, IL1StatusWrite, ConfigEvents, PauserEvents, OAppSender  {
    ...
    constructor(address _lzEndpoint) OAppCore(_lzEndpoint, msg.sender)  {}
